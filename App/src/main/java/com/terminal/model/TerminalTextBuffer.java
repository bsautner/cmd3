...
import com.terminal.StyledTextConsumer;
import com.terminal.StyledTextConsumerAdapter;
...
public class TerminalTextBuffer {
    ...
    private TerminalLine.TextEntry createFillerEntry() {
        return new TerminalLine.TextEntry(createEmptyStyleWithCurrentColor(), new CharBuffer(CharUtils.NUL_CHAR, myWidth));
    }
