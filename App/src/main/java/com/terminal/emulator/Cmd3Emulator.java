...
public class Cmd3Emulator extends DataStreamIteratingEmulator {
    private static final Logger LOG = Logger.getLogger(Cmd3Emulator.class);
    ...
    public Cmd3Emulator(TerminalDataStream dataStream, Terminal terminal) {
