...
import com.terminal.emulator.mouse.TerminalMouseListener;
import com.terminal.model.*;
...
public class TerminalPanel extends JComponent implements TerminalDisplay, TerminalActionProvider {
    ...
    private String myWindowTitle = "CMD3 Terminal";
    ...
    private void establishFontMetrics() {
        ...
        boolean myMonospaced = isMonospaced(fo);
        if (!myMonospaced) {
...
//      }
    ...
    public void setCurrentPath(String path) {
        //TODO: handle current path if available
    }
